resource "aws_s3_bucket_lifecycle_configuration" "tf_state_bucket_config" {
...
resource "aws_s3_bucket_server_side_encryption_configuration" "tf_state_server_side_config" {
    bucket = aws_s3_bucket.tf_state_bucket.id
    rule {
